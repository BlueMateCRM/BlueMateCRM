...
<template>
  ...
  <section class="p-[30px] border border-gray-300 text-textBlack">
    <!-- header -->
    <div
      class="flex justify-between items-end border-b-[5px] border-textBlack mb-5 pb-1"
    >
      <!-- title -->
      <div>
    ...
    <div class="flex mb-10">
      ...
      <div class="w-1/2">
        <h3 class="border-b border-textBlack pb-[10px] font-medium">Shipper</h3>
        <div class="pt-[10px]">
    ...
    <div class="flex mb-10">
      <div class="w-1/2">
        <h3 class="border-b border-textBlack pb-[10px] font-medium">Origin</h3>
        <div class="pt-[10px]">
    ...
    <div class="flex mb-10">
      ...
      <div class="w-2/5">
        ...
        <div class="pt-[10px]">
          <div class="flex mb-[10px]">
            <h4 class="font-medium w-[60%] min-w-[149px]">1st avail pick up</h4>
            <p>12/31/2024</p>
          </div>
          <div class="flex mb-[10px]">
          ...
          <div class="flex mb-[10px]">
            <h4 class="font-medium w-[60%] min-w-[149px]">Vehicle condition</h4>
            <p>Running</p>
          </div>
          <div class="flex mb-[10px]">
